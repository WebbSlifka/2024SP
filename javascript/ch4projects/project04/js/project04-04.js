...
function runTheRegister() {
    ...
    let changeValue = parseFloat(cashBox.value) - parseFloat(billBox.value); // calculate the change

    changeBox.innerHTML = formatCurrency(changeValue); // format the change as currency
